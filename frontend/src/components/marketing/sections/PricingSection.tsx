    ...
    >
      ...
      {isPopular && (
        <div className="absolute -top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
          <span className="inline-block bg-[#F97316] text-white text-xs font-semibold font-[family-name:var(--font-dm-sans)] px-4 py-1 rounded-full shadow-md">
            Most Popular
          </span>
        </div>
      )}

      <h3 className="text-lg font-semibold font-[family-name:var(--font-sora)] text-white text-center mt-2">{plan.name}</h3>
        ...
        <div className="h-16 flex items-end justify-center overflow-hidden">
          <AnimatePresence mode="popLayout">
            <motion.span
              ...
              className="text-5xl font-bold font-[family-name:var(--font-sora)] text-white"
            >
              ${price}
            </motion.span>
          </AnimatePresence>
          <span className="text-base text-slate-400 font-[family-name:var(--font-dm-sans)] ml-1 mb-1.5">/mo</span>
        </div>
        {annual && (
          <p className="text-center text-xs text-slate-500 font-[family-name:var(--font-dm-sans)] mt-1">
      ...
      <ul className="flex-1 space-y-3 mb-8">
        {plan.features.map((feature, fi) => (
          <motion.li
            key={feature}
            className="flex items-start gap-2.5 text-sm font-[family-name:var(--font-dm-sans)] text-slate-300"
      ...
      {isPopular ? (
        <Link href={plan.href} className="block w-full py-3 rounded-xl bg-[#F97316] hover:bg-[#EA6C10] text-white font-semibold font-[family-name:var(--font-dm-sans)] text-sm text-center transition-colors shadow-lg shadow-orange-500/20">
          {plan.cta}
        </Link>
      ) : (
        <Link href={plan.href} className="block w-full py-3 rounded-xl border-2 border-[#2563EB] text-[#2563EB] hover:bg-[#2563EB] hover:text-white font-semibold font-[family-name:var(--font-dm-sans)] text-sm text-center transition-colors">
          {plan.cta}
        </Link>
      )}
    </motion.div>
  ...
  return (
    <section id="pricing" className="relative py-24 lg:py-32">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <span className="text-xs font-semibold tracking-[0.2em] uppercase text-[#2563EB] font-[family-name:var(--font-dm-sans)]">
            Pricing
          </span>
          ...
          <p className="mt-4 text-lg text-slate-400 font-[family-name:var(--font-dm-sans)] max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 mb-14">
          <span className={`text-sm font-[family-name:var(--font-dm-sans)] transition-colors ${!annual ? "text-white font-semibold" : "text-slate-500"}`}>
            Monthly
          </span>
          <button
        ...
        <p className="text-center text-sm text-slate-500 font-[family-name:var(--font-dm-sans)] mt-12">
