...
```bash
INIT=$(node "/Users/matthewfaust/CloAgent/Clo-Agent/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/Users/matthewfaust/CloAgent/Clo-Agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
