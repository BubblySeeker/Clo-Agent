...
- **Global scope**: `/Users/matthewfaust/CloAgent/Clo-Agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/matthewfaust/CloAgent/Clo-Agent/.claude/notes/`)
...
2. Glob `/Users/matthewfaust/CloAgent/Clo-Agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/matthewfaust/CloAgent/Clo-Agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/matthewfaust/CloAgent/Clo-Agent/.claude/notes/` — works in any directory
